sap.ui.define([
	...
	return Opa5.extend("gruppo3.gruppo3.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["gruppo3/gruppo3/localService/mockserver"], function (mockserver) {
